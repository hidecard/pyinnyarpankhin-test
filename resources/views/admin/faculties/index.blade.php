...
<div class="data-section">
    <div class="section-header">
        <h3 class="section-title">
            <i class="fas fa-university"></i> All Faculties
        </h3>
        <a href="{{ route('admin.faculties.create') }}" class="btn-add" title="Add Faculty">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <a href="{{ route('admin.faculties.show', $faculty) }}" class="action-btn view" title="View Details">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('admin.faculties.edit', $faculty) }}" class="action-btn edit" title="Edit">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button
                                    type="button"
                                    class="action-btn delete"
                                    onclick="showDeleteModal(this, {{ $faculty->id }}, '{{ $faculty->faculty_name }}')"
                                    title="Delete"
                                >
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <p>Get started by adding your first faculty member.</p>
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content edu-modal border-0 rounded-4">
            ...
            <div class="modal-body text-center p-4">
                ...
                <p class="fw-semibold text-dark mb-3" id="facultyName"></p>
...
function showDeleteModal(button, facultyId, facultyName) {
    document.getElementById('facultyName').innerText = facultyName;
    document.getElementById('deleteForm').action = `/admin/faculties/${facultyId}`;
    deleteModal.show();
}
