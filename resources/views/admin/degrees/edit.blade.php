...
<div class="data-section">
    ...
    <div class="section-header">
        <h3 class="section-title">
            <i class="fas fa-graduation-cap"></i> Edit Degree
        </h3>
    ...
    <div class="card edu-card">
        <div class="card-header bg-light d-flex align-items-center justify-content-between">
            <h5 class="mb-0"><i class="fas fa-edit me-2"></i>Degree Information</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.degrees.update', $degree) }}" method="POST">
                ...
                <div class="row g-3">
                    <div class="col-md-12">
                        ...
                        @else
                            <small class="text-muted">Enter the full name of the degree</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select @error('level') is-invalid @enderror"
                                ...
                                <option value="postgraduate" {{ old('level', $degree->level) == 'postgraduate' ? 'selected' : '' }}>Postgraduate</option>
                        ...
                        @error('level')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @else
                            <small class="text-muted">Select the academic level</small>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @error('duration_id')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @else
                            <small class="text-muted">Select the duration for this degree</small>
                        @enderror
                    </div>
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select @error('department_id') is-invalid @enderror"
                                ...
                                @foreach($departments as $department)
                                    <option value="{{ $department->id }}" {{ old('department_id', $degree->department_id) == $department->id ? 'selected' : '' }}>
