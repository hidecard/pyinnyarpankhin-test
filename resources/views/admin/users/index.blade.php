...
<div class="data-section">
    <div class="section-header">
        ...
        <a href="{{ route('admin.users.create') }}" class="btn-add" title="Add User">
                            ...
                            <div class="action-buttons">
                                ...
                                @if($user->id !== auth()->id())
                                    <button
                                        ...
                                        onclick="showDeleteModal(this, {{ $user->id }}, '{{ $user->name }}')"
                                        title="Delete"
                                    >
    ...
    <div class="modal-dialog modal-dialog-centered modal-sm">
        <div class="modal-content edu-modal border-0 rounded-4">
            ...
            <div class="modal-body text-center p-4">
                ...
                <p class="fw-semibold text-dark mb-3" id="userName"></p>
...
function showDeleteModal(button, userId, userName) {
